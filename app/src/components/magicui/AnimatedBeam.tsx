...
/** Source: magicuidesign/magicui registry/magicui/animated-beam.tsx. */
...
export function AnimatedBeam({
  ...
  useEffect(() => {
    ...
    const observer = typeof ResizeObserver === 'undefined' ? null : new ResizeObserver(updatePath);
  ...
  return (
    <svg aria-hidden="true" fill="none" width={svgDimensions.width} height={svgDimensions.height}
      className={cn('pg-magic-beam', className)} viewBox={`0 0 ${svgDimensions.width} ${svgDimensions.height}`}>
      <path d={pathD} stroke={pathColor} strokeWidth={pathWidth} strokeOpacity={pathOpacity} strokeLinecap="round" />
      <path d={pathD} strokeWidth={pathWidth} stroke={`url(#${id})`} strokeLinecap="round" />
      <defs>
        <motion.linearGradient id={id} gradientUnits="userSpaceOnUse" initial={{ x1: '0%', x2: '0%', y1: '0%', y2: '0%' }}
